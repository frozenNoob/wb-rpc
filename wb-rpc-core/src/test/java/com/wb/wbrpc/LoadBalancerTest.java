...
import com.wb.wbrpc.loadbalancer.ConsistentHashLoadBalancer;
import com.wb.wbrpc.loadbalancer.LoadBalancer;
import com.wb.wbrpc.loadbalancer.RandomLoadBalancer;
import com.wb.wbrpc.loadbalancer.RoundRobinLoadBalancer;
...
public class LoadBalancerTest {
    ...
    public void select() {
        ...
        serviceMetaInfo2.setServiceHost("wb.icu");
